package top.lihaoyu.store.service.impl;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import top.lihaoyu.store.entity.*;
import top.lihaoyu.store.mapper.OrderMapper;
import top.lihaoyu.store.service.IAddressService;
import top.lihaoyu.store.service.ICartService;
import top.lihaoyu.store.service.IOrderService;
import top.lihaoyu.store.service.IProductService;
import top.lihaoyu.store.service.exception.InsertException;
import top.lihaoyu.store.service.exception.OrderNotExistsException;
import top.lihaoyu.store.service.exception.UpdateException;
